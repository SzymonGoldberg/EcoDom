...
class DevicesTest < ApplicationSystemTestCase
  ...
  test "should create device" do
    ...
    fill_in "Activate", with: @device.activate
    fill_in "Consumption", with: @device.consumption
    fill_in "Deactivate", with: @device.deactivate
    fill_in "Efficiency grade", with: @device.efficiency_grade
